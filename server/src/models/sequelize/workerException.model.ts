...
class WorkerException extends Model<InferAttributes<WorkerException>, InferCreationAttributes<WorkerException>> {
...
// WorkerException.beforeSave(async function(instance) {
    
// });

export default WorkerException;